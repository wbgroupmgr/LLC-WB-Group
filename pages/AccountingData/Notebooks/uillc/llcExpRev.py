"""
uillc.llcExpRev — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.llcExpRev as part of the ui/ refactor
...
``uillc.llcExpRev`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.llcExpRev import *  # noqa: F401,F403
from ui import llcExpRev as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.llcExpRev import X`` continues to resolve names the target
