"""
uillc.stmtGeneralLedger — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.stmtGeneralLedger as part of the ui/ refactor
...
``uillc.stmtGeneralLedger`` keep working unchanged.
