"""
uillc.stmtIncomeStmt — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.stmtIncomeStmt as part of the ui/ refactor
...
``uillc.stmtIncomeStmt`` keep working unchanged.
