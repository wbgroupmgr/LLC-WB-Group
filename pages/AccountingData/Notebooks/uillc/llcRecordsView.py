"""
uillc.llcRecordsView — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.llcRecordsView as part of the ui/ refactor
...
``uillc.llcRecordsView`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.llcRecordsView import *  # noqa: F401,F403
from ui import llcRecordsView as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.llcRecordsView import X`` continues to resolve names the target
