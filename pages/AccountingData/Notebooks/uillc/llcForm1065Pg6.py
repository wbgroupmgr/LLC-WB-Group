"""
uillc.llcForm1065Pg6 — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.llcForm1065Pg6 as part of the ui/ refactor
...
``uillc.llcForm1065Pg6`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.llcForm1065Pg6 import *  # noqa: F401,F403
from ui import llcForm1065Pg6 as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.llcForm1065Pg6 import X`` continues to resolve names the target
