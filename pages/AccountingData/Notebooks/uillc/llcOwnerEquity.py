"""
uillc.stmtOwnerEquity — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.stmtOwnerEquity as part of the ui/ refactor
...
``uillc.stmtOwnerEquity`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.stmtOwnerEquity import *  # noqa: F401,F403
from ui import stmtOwnerEquity as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.stmtOwnerEquity import X`` continues to resolve names the target
