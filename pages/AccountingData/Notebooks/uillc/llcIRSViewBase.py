...
Data is sourced from the official llcFinancialReport databases (IS/BS/owners)
...
class _llcIRSViewBase:
    ...
    Attributes
    ----------
    _is   : dict   — is_data  from llcFinancialReport.taxData()
    _bs   : dict   — bs_data  from llcFinancialReport.taxData()
    ...
    def _loadFromIRS(self, llc) -> None:
        ...
        Priority:
          ...
          2. llcFinancialReport(llc).taxData()  (build fresh)
        """
        try:
        ...
        # Build fresh from llcFinancialReport
        try:
    ...
    def _loadFallback(self, llc) -> None:
        """Last-resort: try loading directly from llcFinancialReport without Form1065."""
        try:
            try:
