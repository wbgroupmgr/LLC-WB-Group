"""
uillc.llcFormSchedM2 — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.llcFormSchedM2 as part of the ui/ refactor
...
``uillc.llcFormSchedM2`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.llcFormSchedM2 import *  # noqa: F401,F403
from ui import llcFormSchedM2 as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.llcFormSchedM2 import X`` continues to resolve names the target
