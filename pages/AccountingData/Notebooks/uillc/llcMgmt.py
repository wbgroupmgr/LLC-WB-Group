"""
uillc.llcMgmt — Compatibility shim (Phase 4 DataModelGuide refactor).

The real implementation moved to ui.llcMgmt as part of the ui/ refactor
...
``uillc.llcMgmt`` keep working unchanged.

Timestamp of last change: 2026.04.19
"""

from ui.llcMgmt import *  # noqa: F401,F403
from ui import llcMgmt as _ui_mod

# Re-export the module-level __all__ if the target defined one, so that
# ``from uillc.llcMgmt import X`` continues to resolve names the target
