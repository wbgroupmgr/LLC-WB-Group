...
class Form4562(irsForm):
    ...
    # Each entry: {"part": label, "status": "auto"|"zero"|"cpa", "summary": str,
    #              "detail": str}
    _PART_NOTES: List[Dict[str, str]] = [
        {
            "part":    "Header (f2–f4)",
            "status":  "auto",
        ...
        },
        {
            ...
            "detail":  (
                ...
                "excluded. The $5,246 in Acct.Fixed.Depreciation.Accum is safe-harbor "
        ...
        },
        {
            ...
            "status":  "auto",
            "summary": "Line 19h filled: 27.5-yr S/L MM, basis $437,950 (⚠ land not yet split), deduction $5,246.",
            "detail":  (
                "Line 19h (residential rental, 27.5 yrs, MM convention, S/L method) is the "
                "core entry. Placed-in-service date: 8/2025. "
                "Current deduction (f74) = $5,246.06 sourced from Acct.Exp.Depreciation — "
        ...
        },
        {
            ...
            "status":  "auto",
            "summary": "Line 22 = $5,246 (total depreciation) → Form 1065 Line 16a → Form 8825 Line 14.",
            "detail":  (
    ...
    # ── Depreciation reconciliation note (shown in Review modal) ────────────
    _DEPR_RECONCILIATION: Dict[str, str] = {
        "title": "Depreciation Account Reconciliation",
        "accounts": {
            "Acct.Exp.Depreciation":       "$5,246.06 (Income Statement — current-year expense)",
            "Acct.Fixed.Depreciation.Accum": "$5,246.06 (Balance Sheet — accumulated contra-asset)",
        },
        "explanation": (
            "These two accounts record the same $5,246.06 as safe-harbor §1.263(a)-3 "
            ...
            "both show the same $5,246 proxy — this is acceptable for Year 1 but should "
